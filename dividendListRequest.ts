...
export const dividendListRequestSchema = {
...
export function dividendListRequestValidator() {
  if (dividendListRequestAjv == null) {
    dividendListRequestAjv = new Ajv({validateSchema: false}).compile(dividendListRequestSchema);
  }
