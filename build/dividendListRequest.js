...
exports.dividendListRequestSchema = {
    ...
    "description": "dividendListRequest schema",
    "type": "object",
    "allOf": [
        {
        ...
        },
        {
            "properties": {
                ...
                "date": {
                    "description": "date event (yyyyMMdd)",
                    "type": [
                        "string",
                        "null"
                    ]
...
let dividendListRequestAjv = null;
function dividendListRequestValidator() {
    if (dividendListRequestAjv == null) {
        dividendListRequestAjv = new Ajv({ validateSchema: false }).compile(exports.dividendListRequestSchema);
    }
    return dividendListRequestAjv;
}
exports.dividendListRequestValidator = dividendListRequestValidator;
//# sourceMappingURL=dividendListRequest.js.map